...
<html lang="en-US">
  ...
  <body>
    ...
    <form action="signup.php" method="POST">
      ...
      <br>
      <input type="password" class="confirm-password" name="confirm_password" pattern="^[A-Za-z0-9]+" placeholder="confirm password" title="Only Letters and Numbers Allowed" required>
      <br>
