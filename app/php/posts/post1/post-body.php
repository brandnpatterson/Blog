...
<?php require 'dist/posts/post1/post-header.php' ?>
...
<div class="post post-body">
  ...
  <p>
    I'm most comfortable right now with using NPM Scripts, Webpack, Pug/Jade (I never used it as Jade), and Sass. I'm quite fond of the power of jQuery, but I'm also continuing to learn about the principles of Modular JavaScript, data structures and I will always be a student of the fundamentals of Computer Science.
  </p>
  <p>
    I almost forgot to mention that I've been using Git and Github for version control locally through the terminal to push and pull versions to and from their servers as well as take advantage of their free hosting, gh-pages. I just recently found out about Surge.sh, which is another free hosting service that I like because the pages have their own page without linking as any sort of subdomain list. I feel really fortunate to have those tools for my static websites.
  </p>
  <p>
  ...
  <p>
    ...
    has an amazing tutorial about the basics of routing, which really left a strong impression on me to create single page apps with little use of frameworks to begin with in order to learn the fundamentals of how frameworks harness JavaScript in the browser and elsewhere.
  </p>
  <p>
    With that said, I recently started a project that uses both of the frameworks Bootstrap and React, so today I wanted to build this Blog that uses neither. I'm looking forward to posting more about what I've learned over the past year, what I'm doing now, and what I am looking to do in the future!
  </p>
  <h2>
    Happy Holidays!
  </h2>
  ...
  <?php require 'dist/posts/back.php' ?>
